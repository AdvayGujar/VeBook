...
function CustomerBasketball() {
    ...
    const fetchBookings = async (selectedDate) => {
        ...
        try {
            ...
            const filteredBookings = data.filter(booking => booking.venue_id === 2 && booking.level >= getLevelVariable());
...
export default CustomerBasketball;
