                    ...
                    try {
                        ...
                        if (response.status === 200) {
                            const mailData = {
                                ...
                                message: `${getNameVariable()}, your request to book the Mondini Hall on ${date} from ${startTime} to ${endTime} has been received`,
                            };
...
export default CustomerMondini;
