...
function FacultyFootball() {
    ...
    const fetchBookings = async (selectedDate) => {
        ...
        try {
            ...
            const filteredBookings = data.filter(booking => booking.venue_id === 1 && booking.level >= getLevelVariable());
                        ...
                        try {
                            ...
                            if (response.status === 200) {
                                ...
                                const mailData = {
                                    ...
                                    message: `${getNameVariable()}, your request to book the Football Ground on ${date} from ${startTime} to ${endTime} has been received`,
                                };
