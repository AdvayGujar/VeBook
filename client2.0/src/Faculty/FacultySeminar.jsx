...
function FacultySeminar() {
    ...
    const fetchBookings = async (selectedDate) => {
        ...
        try {
            ...
            const filteredBookings = data.filter(booking => booking.venue_id === 5 && booking.level >= getLevelVariable());
                        ...
                        try {
                                ...
                                .then(async (response) => {
                                    if (response.ok) {
                                        ...
                                        const mailData = {
                                            name: user.name,
                                            email: user.email,
                                            message: `${user.name} your booked slot for Seminar Hall on ${booking.date} from ${booking.start_time} to ${booking.end_time} has been canceled due to booking by a higher authority.`,
                                        };
                            ...
                            if (response.status === 200) {
                                ...
                                const mailData = {
                                    ...
                                    message: `${getNameVariable()}, your request to book the Seminar Hall on ${date} from ${startTime} to ${endTime} has been received`,
                                };
