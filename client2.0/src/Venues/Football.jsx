...
import venueImage from "../assets/img2.jpg"; // Import the venue image
import backgroundImage from "../assets/img7.jpeg"; // Import the background image
...
function Football() {
  const venueDetails = {
    ...
    description:
      "Don Bosco College of Engineering boasts a meticulously maintained football ground, a vital asset for both students and sports enthusiasts. This verdant pitch provides a pristine playing surface, complete with well-marked boundaries and goalposts. Regular maintenance ensures the safety and enjoyment of athletes, making it a hub for football matches, practice sessions, and college events. The lush surroundings and modern amenities make it a focal point for promoting physical fitness and fostering a sense of community through the beautiful game.",
    location: "Location: DBIT Campus",
  ...
  return (
    <div style={containerStyles}>
      <div style={contentStyles}>
        ...
        <p style={noteStyles}>Please login to book this venue.</p>{" "}
        {/* Note prompting the user to login */}
        <Link to="/landing" style={loginButtonStyles}>
          Login
        </Link>{" "}
